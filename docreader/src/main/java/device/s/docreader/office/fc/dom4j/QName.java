...
public class QName implements Serializable
{
    ...
    static
    {
        try
        {
            String defaultSingletonClass = "device.s.docreader.fc.dom4j.util.SimpleSingleton";
            Class clazz = null;
            try
            {
                String singletonClass = defaultSingletonClass;
                singletonClass = System.getProperty("device.s.docreader.fc.dom4j.QName.singleton.strategy",
                    singletonClass);
