...
//        btn.setNormalBgResID(R.drawable.doc_toolsbar_button_bg_normal);
//        btn.setPushBgResID(R.drawable.doc_toolsbar_button_bg_push);
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
       ...
       {
           setBackgroundResource(R.drawable.doc_toolsbar_button_bg_normal);
       }
    }
