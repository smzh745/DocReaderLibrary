...
import device.s.docreader.office.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import device.s.docreader.office.fc.hssf.formula.IStabilityClassifier;
import device.s.docreader.office.fc.hssf.formula.WorkbookEvaluator;
...
import device.s.docreader.office.fc.ss.usermodel.CellValue;
import device.s.docreader.office.fc.ss.usermodel.FormulaEvaluator;
import device.s.docreader.office.fc.ss.usermodel.ICell;
import device.s.docreader.office.fc.ss.usermodel.Workbook;
...
public class HSSFFormulaEvaluator implements FormulaEvaluator
{
     ...
     * replaced with the result of the formula, use {@link #evaluateInCell(com.device.s.docreader.office.fc.ss.usermodel.ICell)}
