package device.s.docreader.office.fc.hwpf;

import device.s.docreader.office.fc.hwpf.model.BookmarksTables;
import device.s.docreader.office.fc.hwpf.model.CHPBinTable;
import device.s.docreader.office.fc.hwpf.model.CPSplitCalculator;
import device.s.docreader.office.fc.hwpf.model.ComplexFileTable;
import device.s.docreader.office.fc.hwpf.model.EscherRecordHolder;
import device.s.docreader.office.fc.hwpf.model.FSPADocumentPart;
import device.s.docreader.office.fc.hwpf.model.FSPATable;
import device.s.docreader.office.fc.hwpf.model.FieldsTables;
import device.s.docreader.office.fc.hwpf.model.FontTable;
import device.s.docreader.office.fc.hwpf.model.ListTables;
import device.s.docreader.office.fc.hwpf.model.PAPBinTable;
import device.s.docreader.office.fc.hwpf.model.PicturesTable;
import device.s.docreader.office.fc.hwpf.model.PlcfTxbxBkd;
import device.s.docreader.office.fc.hwpf.model.SectionTable;
import device.s.docreader.office.fc.hwpf.model.ShapesTable;
import device.s.docreader.office.fc.hwpf.model.StyleSheet;
import device.s.docreader.office.fc.hwpf.model.SubdocumentType;
import device.s.docreader.office.fc.hwpf.model.TextPieceTable;
import device.s.docreader.office.fc.hwpf.usermodel.Bookmarks;
import device.s.docreader.office.fc.hwpf.usermodel.BookmarksImpl;
import device.s.docreader.office.fc.hwpf.usermodel.Field;
import device.s.docreader.office.fc.hwpf.usermodel.Fields;
import device.s.docreader.office.fc.hwpf.usermodel.FieldsImpl;
import device.s.docreader.office.fc.hwpf.usermodel.HWPFList;
import device.s.docreader.office.fc.hwpf.usermodel.OfficeDrawings;
import device.s.docreader.office.fc.hwpf.usermodel.OfficeDrawingsImpl;
...
{
    private static final String PROPERTY_PRESERVE_BIN_TABLES = "device.s.docreader.fc.hwpf.preserveBinTables";
    private static final String PROPERTY_PRESERVE_TEXT_TABLE = "device.s.docreader.fc.hwpf.preserveTextTable";
