...
package device.s.docreader.office.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link device.s.docreader.office.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link device.s.docreader.office.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see device.s.docreader.office.fc.hwpf.usermodel.Shape
 * @see device.s.docreader.office.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
