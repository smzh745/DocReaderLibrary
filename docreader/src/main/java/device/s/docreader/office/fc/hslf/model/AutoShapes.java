...
import device.s.docreader.office.java.awt.geom.Line2D;
...
public final class AutoShapes
{
     ...
     *
    */
    public static device.s.docreader.office.java.awt.Shape transform(device.s.docreader.office.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public device.s.docreader.office.java.awt.Shape getOutline(Shape shape)
            {
