...
import device.s.docreader.office.fc.hpsf.DocumentSummaryInformation;
import device.s.docreader.office.fc.hpsf.MutablePropertySet;
import device.s.docreader.office.fc.hpsf.PropertySet;
import device.s.docreader.office.fc.hpsf.PropertySetFactory;
import device.s.docreader.office.fc.hpsf.SummaryInformation;
...
import device.s.docreader.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(device.s.docreader.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(device.s.docreader.office.fc.hpsf.WritingNotSupportedException wnse)
        {
