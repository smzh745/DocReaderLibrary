...
import device.s.docreader.office.fc.ddf.EscherBSERecord;
import device.s.docreader.office.fc.ddf.EscherBoolProperty;
import device.s.docreader.office.fc.ddf.EscherContainerRecord;
import device.s.docreader.office.fc.ddf.EscherDgRecord;
import device.s.docreader.office.fc.ddf.EscherDggRecord;
import device.s.docreader.office.fc.ddf.EscherOptRecord;
import device.s.docreader.office.fc.ddf.EscherProperties;
import device.s.docreader.office.fc.ddf.EscherRGBProperty;
import device.s.docreader.office.fc.ddf.EscherRecord;
import device.s.docreader.office.fc.ddf.EscherSimpleProperty;
import device.s.docreader.office.fc.ddf.EscherSpRecord;
import device.s.docreader.office.fc.ddf.EscherSplitMenuColorsRecord;
...
import device.s.docreader.office.fc.hssf.formula.FormulaShifter;
...
import device.s.docreader.office.fc.hssf.formula.ptg.OperandPtg;
import device.s.docreader.office.fc.hssf.formula.ptg.Ptg;
import device.s.docreader.office.fc.hssf.formula.ptg.Ref3DPtg;
import device.s.docreader.office.fc.hssf.formula.udf.UDFFinder;
import device.s.docreader.office.fc.hssf.record.BOFRecord;
import device.s.docreader.office.fc.hssf.record.BackupRecord;
import device.s.docreader.office.fc.hssf.record.BookBoolRecord;
import device.s.docreader.office.fc.hssf.record.BoundSheetRecord;
import device.s.docreader.office.fc.hssf.record.CodepageRecord;
import device.s.docreader.office.fc.hssf.record.CountryRecord;
import device.s.docreader.office.fc.hssf.record.DSFRecord;
import device.s.docreader.office.fc.hssf.record.DateWindow1904Record;
import device.s.docreader.office.fc.hssf.record.DrawingGroupRecord;
import device.s.docreader.office.fc.hssf.record.EOFRecord;
import device.s.docreader.office.fc.hssf.record.EscherAggregate;
import device.s.docreader.office.fc.hssf.record.ExtSSTRecord;
import device.s.docreader.office.fc.hssf.record.ExtendedFormatRecord;
import device.s.docreader.office.fc.hssf.record.ExternSheetRecord;
import device.s.docreader.office.fc.hssf.record.FileSharingRecord;
import device.s.docreader.office.fc.hssf.record.FnGroupCountRecord;
import device.s.docreader.office.fc.hssf.record.FontRecord;
import device.s.docreader.office.fc.hssf.record.FormatRecord;
import device.s.docreader.office.fc.hssf.record.HideObjRecord;
import device.s.docreader.office.fc.hssf.record.HyperlinkRecord;
import device.s.docreader.office.fc.hssf.record.InterfaceEndRecord;
import device.s.docreader.office.fc.hssf.record.InterfaceHdrRecord;
import device.s.docreader.office.fc.hssf.record.MMSRecord;
import device.s.docreader.office.fc.hssf.record.NameCommentRecord;
import device.s.docreader.office.fc.hssf.record.NameRecord;
import device.s.docreader.office.fc.hssf.record.PaletteRecord;
import device.s.docreader.office.fc.hssf.record.PasswordRecord;
import device.s.docreader.office.fc.hssf.record.PasswordRev4Record;
import device.s.docreader.office.fc.hssf.record.PrecisionRecord;
import device.s.docreader.office.fc.hssf.record.ProtectRecord;
import device.s.docreader.office.fc.hssf.record.ProtectionRev4Record;
import device.s.docreader.office.fc.hssf.record.RecalcIdRecord;
import device.s.docreader.office.fc.hssf.record.Record;
import device.s.docreader.office.fc.hssf.record.RefreshAllRecord;
import device.s.docreader.office.fc.hssf.record.SSTRecord;
import device.s.docreader.office.fc.hssf.record.StyleRecord;
import device.s.docreader.office.fc.hssf.record.SupBookRecord;
import device.s.docreader.office.fc.hssf.record.TabIdRecord;
import device.s.docreader.office.fc.hssf.record.UseSelFSRecord;
import device.s.docreader.office.fc.hssf.record.WindowOneRecord;
import device.s.docreader.office.fc.hssf.record.WindowProtectRecord;
import device.s.docreader.office.fc.hssf.record.WriteAccessRecord;
import device.s.docreader.office.fc.hssf.record.WriteProtectRecord;
import device.s.docreader.office.fc.hssf.record.common.UnicodeString;
import device.s.docreader.office.fc.hssf.util.HSSFColor;
import device.s.docreader.office.fc.ss.usermodel.BuiltinFormats;
...
import device.s.docreader.office.system.AbortReaderError;
 ...
 * @see device.s.docreader.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
    ...
    public int addSSTString(UnicodeString string)
    {
        ...
        return sst.addString((device.s.docreader.office.fc.hssf.record.UnicodeString) string);
    }
    ...
    */
     ...
     *
     * @see device.s.docreader.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
