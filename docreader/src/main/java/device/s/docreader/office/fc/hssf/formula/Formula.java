...
import device.s.docreader.office.fc.hssf.formula.ptg.TblPtg;
import device.s.docreader.office.fc.ss.util.CellReference;
import device.s.docreader.office.fc.util.LittleEndian;
import device.s.docreader.office.fc.util.LittleEndianByteArrayInputStream;
...
public class Formula {
	...
	/**
	 * Gets the locator for the corresponding {@link device.s.docreader.office.fc.hssf.record.SharedFormulaRecord},
     * {@link device.s.docreader.office.fc.hssf.record.ArrayRecord} or {@link device.s.docreader.office.fc.hssf.record.TableRecord}
