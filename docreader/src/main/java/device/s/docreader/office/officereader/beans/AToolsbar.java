...
//        BitmapFactory.decodeResource(getResources(),  R.drawable.doc_toolsbar_button_bg_normal, opts);
        this.buttonWidth = opts.outWidth;
        this.buttonHeight = opts.outHeight;
        
//        toolsbarFrame.setBackgroundResource(R.drawable.doc_toolsbar_button_bg_normal);
...
//        tb.setNormalBgResID(R.drawable.doc_toolsbar_button_bg_normal);
//        tb.setPushBgResID(R.drawable.doc_toolsbar_button_bg_push);
...
//        tb.setPushBgResID(R.drawable.doc_toolsbar_button_bg_push);
    ...
    protected void addSeparated()
    {
        toolsbarFrame.addView(new AImageButton(getContext(), control, "", 
            R.drawable.doc_toolsbar_separated_horizontal, -1,  -1),
