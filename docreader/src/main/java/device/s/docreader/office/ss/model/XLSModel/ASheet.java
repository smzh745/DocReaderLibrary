 ...
 * 时间:              下午1:55:20
 */
package device.s.docreader.office.ss.model.XLSModel;
...
import device.s.docreader.office.common.borders.Line;
...
import device.s.docreader.office.common.shape.AChart;
...
import device.s.docreader.office.fc.hssf.model.InternalSheet;
import device.s.docreader.office.fc.hssf.model.InternalWorkbook;
import device.s.docreader.office.fc.hssf.record.BlankRecord;
...
import device.s.docreader.office.fc.hssf.usermodel.HSSFAutoShape;
import device.s.docreader.office.fc.hssf.usermodel.HSSFChart;
import device.s.docreader.office.fc.hssf.usermodel.HSSFChildAnchor;
import device.s.docreader.office.fc.hssf.usermodel.HSSFClientAnchor;
import device.s.docreader.office.fc.hssf.usermodel.HSSFFreeform;
import device.s.docreader.office.fc.hssf.usermodel.HSSFLine;
import device.s.docreader.office.fc.hssf.usermodel.HSSFPatriarch;
import device.s.docreader.office.fc.hssf.usermodel.HSSFPicture;
import device.s.docreader.office.fc.hssf.usermodel.HSSFPictureData;
import device.s.docreader.office.fc.hssf.usermodel.HSSFRichTextString;
import device.s.docreader.office.fc.hssf.usermodel.HSSFShape;
import device.s.docreader.office.fc.hssf.usermodel.HSSFShapeGroup;
import device.s.docreader.office.fc.hssf.usermodel.HSSFSheet;
import device.s.docreader.office.fc.hssf.usermodel.HSSFTextbox;
...
import device.s.docreader.office.fc.xls.ChartConverter;
import device.s.docreader.office.java.awt.Rectangle;
import device.s.docreader.office.ss.model.CellRangeAddress;
import device.s.docreader.office.ss.model.baseModel.Cell;
...
import device.s.docreader.office.ss.model.drawing.AnchorPoint;
import device.s.docreader.office.ss.model.drawing.CellAnchor;
import device.s.docreader.office.ss.model.sheetProperty.PaneInformation;
import device.s.docreader.office.ss.util.ModelUtil;
import device.s.docreader.office.ss.util.SectionElementFactory;
...
import device.s.docreader.office.thirdpart.achartengine.chart.RoundChart;
import device.s.docreader.office.thirdpart.achartengine.chart.XYChart;
import device.s.docreader.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements device.s.docreader.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<device.s.docreader.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<device.s.docreader.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                device.s.docreader.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                device.s.docreader.office.ss.model.sheetProperty.ColumnInfo columnInfo = new device.s.docreader.office.ss.model.sheetProperty.ColumnInfo(
