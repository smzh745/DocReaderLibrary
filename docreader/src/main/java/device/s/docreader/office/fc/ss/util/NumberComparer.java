...
import static device.s.docreader.office.fc.ss.util.IEEEDouble.*;
import static device.s.docreader.office.fc.ss.util.IEEEDouble.BIASED_EXPONENT_SPECIAL_VALUE;
import static device.s.docreader.office.fc.ss.util.IEEEDouble.EXPONENT_BIAS;
import static device.s.docreader.office.fc.ss.util.IEEEDouble.FRAC_MASK;
import static device.s.docreader.office.fc.ss.util.IEEEDouble.getBiasedExponent;
