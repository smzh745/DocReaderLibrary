 ...
 * example in {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.FormulaEvaluator#evaluateFormulaCell(org.apache.poi.ss.usermodel.Cell)})
