package device.s.docreader.office.common.autoshape;
...
import static device.s.docreader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getCubicBezArrowPath;
import static device.s.docreader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getDirectLineArrowPath;
import static device.s.docreader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getQuadBezArrowPath;
import static device.s.docreader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getReferencedPosition;
...
public class ArbitraryPolygonShapePath {
    ...
    private static Path getArrowPath(ArbitraryPolygonShape arbitraryPolygonShape, Element pathElement, Rectangle rect, BackgroundAndFill fill, boolean border, PointF headerArrowTailCenter, PointF tailArrowTailCenter) {
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            if (headerArrowTailCenter != null
                ...
                //header arrow
                pathClosed = false;
                headerArrowTailCenter = getReferencedPosition(e.element("pt"), headerArrowTailCenter, arbitraryPolygonShape.getStartArrowType());
                ...
                if (e.getName().equals("lnTo")) {
                    tailArrowTailCenter = getReferencedPosition(e.element("pt"), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
                    ...
                    tailArrowTailCenter =getReferencedPosition((Element) ptList.get(1), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
                    ...
                    tailArrowTailCenter =getReferencedPosition((Element) ptList.get(2), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
    ...
    public static ArrowPathAndTail getPathHeadArrowPath(Arrow arrow, int lineWidth, Element pathElement) {
        ...
        if (e.getName().equals("lnTo")) {
            ...
            path = getDirectLineArrowPath(p1X, p1Y, p0X, p0Y, arrow, lineWidth);
            ...
            if (ptList.size() == 2) {
                ...
                path = getQuadBezArrowPath(p1X, p1Y, ctrX1, ctrY1, p0X, p0Y, arrow, lineWidth);
            }
            ...
            if (ptList.size() == 3) {
                ...
                path = getCubicBezArrowPath(p1X, p1Y, ctrX2, ctrY2, ctrX1, ctrY1, p0X, p0Y, arrow, lineWidth);
            }
        }
    ...
    public static ArrowPathAndTail getPathTailArrowPath(Arrow arrow, int lineWidth, Element pathElement) {
        ...
        if (e.getName().equals("lnTo")) {
            ...
            arrowPathAndTail = getDirectLineArrowPath(p0X, p0Y, p1X, p1Y, arrow, lineWidth);
        } else if (e.getName().equals("quadBezTo")) {
            List ptList = e.elements();
            if (ptList.size() == 2) {
                float ctrX1 = Integer.parseInt(((Element) ptList.get(0)).attributeValue("x")) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH;
                ...
                arrowPathAndTail = getQuadBezArrowPath(p0X, p0Y, ctrX1, ctrY1, p1X, p1Y, arrow, lineWidth);
            }
            ...
            if (ptList.size() == 3) {
                ...
                arrowPathAndTail =getCubicBezArrowPath(p0X, p0Y, ctrX1, ctrY1, ctrX2, ctrY2, p1X, p1Y, arrow, lineWidth);
            }
        }
