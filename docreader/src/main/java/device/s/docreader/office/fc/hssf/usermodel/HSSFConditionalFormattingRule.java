...
import device.s.docreader.office.fc.hssf.record.CFRuleRecord.ComparisonOperator;
import device.s.docreader.office.fc.hssf.record.cf.BorderFormatting;
import device.s.docreader.office.fc.hssf.record.cf.FontFormatting;
import device.s.docreader.office.fc.hssf.record.cf.PatternFormatting;
