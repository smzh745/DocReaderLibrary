...
import device.s.docreader.office.fc.hssf.record.AutoFilterInfoRecord;
import device.s.docreader.office.fc.hssf.record.CellValueRecordInterface;
import device.s.docreader.office.fc.hssf.record.DVRecord;
...
import device.s.docreader.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import device.s.docreader.office.fc.hssf.util.Region;
import device.s.docreader.office.fc.ss.SpreadsheetVersion;
import device.s.docreader.office.fc.ss.usermodel.CellRange;
import device.s.docreader.office.fc.ss.usermodel.DataValidation;
import device.s.docreader.office.fc.ss.usermodel.DataValidationHelper;
import device.s.docreader.office.fc.ss.usermodel.ICell;
import device.s.docreader.office.fc.ss.usermodel.ICellStyle;
import device.s.docreader.office.fc.ss.usermodel.IRow;
...
import device.s.docreader.office.fc.ss.util.SSCellRange;
import device.s.docreader.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements device.s.docreader.office.fc.ss.usermodel.Sheet
{
     ...
     * @see HSSFRow
     * @see #removeRow(com.device.s.docreader.office.fc.ss.usermodel.IRow)
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(device.s.docreader.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link device.s.docreader.office.ss.model.baseModel.device.s.docreader.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see device.s.docreader.office.ss.model.baseModel.device.s.docreader.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
