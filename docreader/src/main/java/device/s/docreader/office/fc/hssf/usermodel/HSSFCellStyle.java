...
import device.s.docreader.office.fc.ss.usermodel.IFont;
...
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(device.s.docreader.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(device.s.docreader.office.fc.ss.usermodel.Workbook parentWorkbook) {
