...
import device.s.docreader.office.fc.POIDocument;
import device.s.docreader.office.fc.codec.DigestUtils;
import device.s.docreader.office.fc.ddf.EscherBSERecord;
import device.s.docreader.office.fc.ddf.EscherBitmapBlip;
import device.s.docreader.office.fc.ddf.EscherBlipRecord;
import device.s.docreader.office.fc.ddf.EscherRecord;
import device.s.docreader.office.fc.hssf.OldExcelFormatException;
import device.s.docreader.office.fc.hssf.formula.FormulaShifter;
import device.s.docreader.office.fc.hssf.formula.SheetNameFormatter;
import device.s.docreader.office.fc.hssf.formula.ptg.Area3DPtg;
import device.s.docreader.office.fc.hssf.formula.ptg.MemFuncPtg;
import device.s.docreader.office.fc.hssf.formula.ptg.Ptg;
import device.s.docreader.office.fc.hssf.formula.ptg.UnionPtg;
import device.s.docreader.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import device.s.docreader.office.fc.hssf.formula.udf.UDFFinder;
import device.s.docreader.office.fc.hssf.model.DrawingManager2;
...
import device.s.docreader.office.fc.hssf.model.RecordStream;
import device.s.docreader.office.fc.hssf.record.AbstractEscherHolderRecord;
...
import device.s.docreader.office.fc.hssf.record.RecordFactory;
...
import device.s.docreader.office.fc.hssf.util.CellReference;
import device.s.docreader.office.fc.poifs.filesystem.DirectoryNode;
import device.s.docreader.office.fc.poifs.filesystem.POIFSFileSystem;
import device.s.docreader.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import device.s.docreader.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements device.s.docreader.office.fc.ss.usermodel.Workbook
{
...
//            names.add(name);
     ...
     */
    public int getSheetIndex(device.s.docreader.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see device.s.docreader.office.fc.hssf.record.FormatRecord
     * @see Record
     */
