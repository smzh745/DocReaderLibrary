...
import device.s.docreader.office.fc.hslf.record.ColorSchemeAtom;
import device.s.docreader.office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(device.s.docreader.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new device.s.docreader.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see device.s.docreader.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public device.s.docreader.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (device.s.docreader.office.fc.hslf.record.Slide)getSheetContainer();
    }
