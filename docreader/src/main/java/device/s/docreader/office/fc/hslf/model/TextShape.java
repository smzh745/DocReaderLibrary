package device.s.docreader.office.fc.hslf.model;
...
import device.s.docreader.office.fc.hslf.record.EscherTextboxWrapper;
import device.s.docreader.office.fc.hslf.record.InteractiveInfo;
import device.s.docreader.office.fc.hslf.record.InteractiveInfoAtom;
import device.s.docreader.office.fc.hslf.record.OEPlaceholderAtom;
import device.s.docreader.office.fc.hslf.record.OutlineTextRefAtom;
import device.s.docreader.office.fc.hslf.record.PPDrawing;
import device.s.docreader.office.fc.hslf.record.Record;
import device.s.docreader.office.fc.hslf.record.RecordTypes;
import device.s.docreader.office.fc.hslf.record.RoundTripHFPlaceholder12;
import device.s.docreader.office.fc.hslf.record.StyleTextPropAtom;
import device.s.docreader.office.fc.hslf.record.TextCharsAtom;
import device.s.docreader.office.fc.hslf.record.TextHeaderAtom;
import device.s.docreader.office.fc.hslf.record.TextRulerAtom;
import device.s.docreader.office.fc.hslf.record.TxInteractiveInfoAtom;
...
public abstract class TextShape extends SimpleShape {
            ...
            for (int i = 0; i < children.length; i++) {
                if (children[i] != null) {
                    ...
                    if (rType == RecordTypes.SlideNumberMCAtom.typeID) {
                        return device.s.docreader.office.common.shape.TextBox.MC_SlideNumber;
                    } else if (rType == RecordTypes.DateTimeMCAtom.typeID) {
                        return device.s.docreader.office.common.shape.TextBox.MC_DateTime;
                    } else if (rType == RecordTypes.GenericDateMCAtom.typeID) {
                        return device.s.docreader.office.common.shape.TextBox.MC_GenericDate;
                    } else if (rType == RecordTypes.RTFDateTimeMCAtom.typeID) {
                        return device.s.docreader.office.common.shape.TextBox.MC_RTFDateTime;
                    } else if (rType == RecordTypes.FooterMCAtom.typeID) {
                        return device.s.docreader.office.common.shape.TextBox.MC_Footer;
                    }
                }
            }
        }
     ...
     * @see device.s.docreader.office.fc.hslf.usermodel.SlideShow#addHyperlink(Hyperlink)
     */
