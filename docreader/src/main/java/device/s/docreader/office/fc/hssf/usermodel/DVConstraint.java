...
import device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint;
...
public class DVConstraint implements DataValidationConstraint {
	 ...
	 * 
	 * @param validationType one of {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.ValidationType#ANY},
     * {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.ValidationType#DECIMAL},
     * {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.ValidationType#INTEGER},
     * {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
	 * @param comparisonOperator any constant from {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.OperatorType} enum
	 ...
	 * 
	 * @param comparisonOperator constant from {@link device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.device.s.docreader.office.fc.ss.usermodel.DataValidationConstraint.OperatorType} enum
