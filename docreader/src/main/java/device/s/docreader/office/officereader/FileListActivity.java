...
import device.s.docreader.office.officereader.filelist.FileDialogAction;
import device.s.docreader.office.officereader.filelist.FileItem;
import device.s.docreader.office.officereader.filelist.FileItemAdapter;
import device.s.docreader.office.officereader.filelist.FileItemView;
import device.s.docreader.office.officereader.filelist.FileRenameDialog;
import device.s.docreader.office.officereader.filelist.FileSort;
import device.s.docreader.office.officereader.filelist.FileSortType;
import device.s.docreader.office.officereader.filelist.FileToolsbar;
import device.s.docreader.office.officereader.filelist.NewFolderDialog;
import device.s.docreader.office.officereader.filelist.SortDialog;
import device.s.docreader.office.officereader.search.ISearchResult;
import device.s.docreader.office.officereader.search.Search;
...
import device.s.docreader.office.system.dialog.QuestionDialog;
...
public class FileListActivity extends Activity implements ISearchResult
{
    ...
    public void actionEvent(int actionID, Object obj)
    {
        ...
        switch (actionID)
        {
            ...
            case EventConstant.FILE_PASTE_ID:           // 粘贴
              ...
              /*  else
                {
                    CharSequence message = getResources().getText(R.string.remove_ads);
                    new MessageDialog(control, this, dialogAction, null, 
                        DialogConstant.MESSAGE_DIALOG_ID, 
                        R.string.border_dialog_title, message.toString()).show();
                }*/
                break;
            ...
            case EventConstant.FILE_SORT_ID:            // 排序
                ...
                new SortDialog(control, this, dialogAction, vectorSort, 
                    ...
                    R.string.select_all, R.array.setting_items).show();
                break;
            ...
            case EventConstant.SYS_HELP_ID:             // 帮助
                Intent intent = new Intent(Intent.ACTION_VIEW,
                    Uri.parse(getResources().getString(R.string.about_string)));
            ...
            case EventConstant.FILE_CREATE_FOLDER_FAILED_ID:
                CharSequence text = getResources().getText(R.string.save_first);
                new MessageDialog(control, this, dialogAction, null, 
                    DialogConstant.MESSAGE_DIALOG_ID, 
                    R.string.save_current, text.toString()).show();
                break;
    ...
    private void listFiles(File[] files)
    {
        ...
        else
        {
            ...
            emptyView.setText(R.string.allow_storage_permission);
            listView.setEmptyView(emptyView);
        }
    } 
    ...
    public void filePaste()
    {
        ...
        {
            CharSequence message = getResources().getText(R.string.empty);
            new MessageDialog(control, this, dialogAction, null, 
                DialogConstant.MESSAGE_DIALOG_ID, 
                R.string.empty, message.toString()).show();
        }
    }
    ...
    public void fileShare()
    {
        ...
        startActivity(Intent.createChooser(intent, getResources().getText(R.string.empty)));
    }
