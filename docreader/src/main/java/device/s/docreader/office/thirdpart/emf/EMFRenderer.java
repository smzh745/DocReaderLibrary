...
import device.s.docreader.office.java.awt.Image;
...
import device.s.docreader.office.java.awt.geom.Area;
import device.s.docreader.office.java.awt.geom.GeneralPath;
import device.s.docreader.office.java.awt.geom.IllegalPathStateException;
import device.s.docreader.office.java.awt.geom.PathIterator;
import device.s.docreader.office.simpletext.font.Font;
import device.s.docreader.office.thirdpart.emf.data.BasicStroke;
import device.s.docreader.office.thirdpart.emf.data.GDIObject;
import device.s.docreader.office.thirdpart.emf.io.Tag;
...
{
    private static final Logger logger = Logger.getLogger("device.s.docreader.office.thirdpart.emf");
