 ...
 * 时间:               上午11:21:10
 */
package device.s.docreader.office.pg.dialog;
...
import device.s.docreader.office.system.beans.ADialog;
...
public class NotesDialog extends ADialog
{
    ...
    {
        super(control, context, action, model, dialogID, R.string.note);
        init(context);
    }
