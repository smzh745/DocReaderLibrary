...
public class SysFrame extends LinearLayout
{
    ...
    public SysFrame(Context context, IControl control)
    {
        ...
        setBackgroundResource(R.drawable.doc_background);
    ...
    private void initVertical(Resources res)
    {
        ...
        // 搜索
        BitmapFactory.decodeResource(res,R.drawable.ic_search_white_24dp, opts);
        AImageButton search = new AImageButton(context, control, "",  R.drawable.ic_search_white_24dp, -1, EventConstant.SYS_SEARCH_ID);
        search.setPushBgResID(R.drawable.doc_search_bg_push);
        ...
        BitmapFactory.decodeResource(context.getResources(),  R.drawable.doc_button_normal_bg_vertical, opts);
...
//        tb.setNormalBgResID(R.drawable.doc_button_normal_bg_vertical);
//        tb.setPushBgResID(R.drawable.sys_button_push_bg_vertical);
//        tb.setFocusBgResID(R.drawable.doc_button_focus_bg_vertical);
...
//    }
    ...
    private void initHorizontal(Resources res)
    {
        ...
        BitmapFactory.decodeResource(context.getResources(), R.drawable.doc_button_normal_bg_horizontal, opts);
...
//        tb.setLayoutParams(params);
//        tb.setNormalBgResID(R.drawable.doc_button_normal_bg_horizontal);
//        tb.setPushBgResID(R.drawable.sys_button_push_bg_horizontal);
//        tb.setFocusBgResID(R.drawable.doc_button_focus_bg_horizontal);
//        tb.setOnClickListener(onClickListener);
//        return tb;
//    }
    /**
