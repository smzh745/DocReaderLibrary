package device.s.docreader.office.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(device.s.docreader.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
