 ...
 * 时间:              上午10:51:56
 */
package device.s.docreader.office.officereader.search;

import device.s.docreader.office.constant.MainConstant;
import device.s.docreader.office.fc.doc.DOCReader;
import device.s.docreader.office.fc.doc.DOCXReader;
import device.s.docreader.office.fc.doc.TXTReader;
import device.s.docreader.office.fc.pdf.PDFReader;
import device.s.docreader.office.fc.ppt.PPTReader;
import device.s.docreader.office.fc.ppt.PPTXReader;
import device.s.docreader.office.fc.xls.XLSReader;
import device.s.docreader.office.fc.xls.XLSXReader;
