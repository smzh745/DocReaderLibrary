...
import device.s.docreader.office.common.autoshape.ArbitraryPolygonShapePath;
import device.s.docreader.office.common.autoshape.AutoShapeTypes;
...
import device.s.docreader.office.common.shape.SmartArt;
...
import device.s.docreader.office.fc.ppt.attribute.ParaAttr;
import device.s.docreader.office.fc.ppt.attribute.RunAttr;
import device.s.docreader.office.fc.ppt.attribute.SectionAttr;
import device.s.docreader.office.fc.ppt.reader.BackgroundReader;
import device.s.docreader.office.fc.ppt.reader.PictureReader;
import device.s.docreader.office.fc.ppt.reader.ReaderKit;
import device.s.docreader.office.fc.ppt.reader.TableReader;
import device.s.docreader.office.fc.xls.Reader.drawing.ChartReader;
import device.s.docreader.office.java.awt.Rectangle;
import device.s.docreader.office.pg.model.PGLayout;
import device.s.docreader.office.pg.model.PGMaster;
import device.s.docreader.office.pg.model.PGModel;
import device.s.docreader.office.pg.model.PGPlaceholderUtil;
import device.s.docreader.office.pg.model.PGSlide;
import device.s.docreader.office.pg.model.PGStyle;
