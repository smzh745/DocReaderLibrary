package device.s.docreader.office.fc.hslf;

import device.s.docreader.office.constant.EventConstant;
import device.s.docreader.office.fc.fs.filesystem.CFBFileSystem;
import device.s.docreader.office.fc.fs.filesystem.Property;
import device.s.docreader.office.fc.hslf.blip.Metafile;
import device.s.docreader.office.fc.hslf.exceptions.CorruptPowerPointFileException;
import device.s.docreader.office.fc.hslf.exceptions.EncryptedPowerPointFileException;
import device.s.docreader.office.fc.hslf.model.Picture;
import device.s.docreader.office.fc.hslf.record.CurrentUserAtom;
import device.s.docreader.office.fc.hslf.record.ExOleObjStg;
import device.s.docreader.office.fc.hslf.record.PersistPtrHolder;
import device.s.docreader.office.fc.hslf.record.PersistRecord;
import device.s.docreader.office.fc.hslf.record.Record;
import device.s.docreader.office.fc.hslf.record.UserEditAtom;
import device.s.docreader.office.fc.hslf.usermodel.ObjectData;
