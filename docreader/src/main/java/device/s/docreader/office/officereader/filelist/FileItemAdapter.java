...
public class FileItemAdapter extends BaseAdapter {
    ...
    public FileItemAdapter(Context context, IControl control) {
        ...
        // folder        
        iconMap.put(ICON_TYPE_FOLDER, res.getDrawable(R.drawable.fp_folder));
        // doc
        iconMap.put(ICON_TYPE_DOC, res.getDrawable(R.drawable.doc));
        // docx
        iconMap.put(ICON_TYPE_DOCX, res.getDrawable(R.drawable.doc));
        // xls
        iconMap.put(ICON_TYPE_XSL, res.getDrawable(R.drawable.xls));
        // xlsx
        iconMap.put(ICON_TYPE_XLSX, res.getDrawable(R.drawable.xls));
        // ppt
        iconMap.put(ICON_TYPE_PPT, res.getDrawable(R.drawable.ppt));
        // pptx
        iconMap.put(ICON_TYPE_PPTX, res.getDrawable(R.drawable.ppt));
        // txt
        iconMap.put(ICON_TYPE_TXT, res.getDrawable(R.drawable.txt));
        // stat
        iconMap.put(ICON_TYPE_STAR, res.getDrawable(R.drawable.star));
        // pdf
        iconMap.put(ICON_TYPE_PDF, res.getDrawable(R.drawable.pdf));
    }
