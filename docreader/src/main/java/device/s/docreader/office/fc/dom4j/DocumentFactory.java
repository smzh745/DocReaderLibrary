...
package device.s.docreader.office.fc.dom4j;

import device.s.docreader.office.fc.dom4j.rule.Pattern;
import device.s.docreader.office.fc.dom4j.tree.AbstractDocument;
import device.s.docreader.office.fc.dom4j.tree.DefaultAttribute;
import device.s.docreader.office.fc.dom4j.tree.DefaultCDATA;
import device.s.docreader.office.fc.dom4j.tree.DefaultComment;
import device.s.docreader.office.fc.dom4j.tree.DefaultDocument;
import device.s.docreader.office.fc.dom4j.tree.DefaultDocumentType;
import device.s.docreader.office.fc.dom4j.tree.DefaultElement;
import device.s.docreader.office.fc.dom4j.tree.DefaultEntity;
import device.s.docreader.office.fc.dom4j.tree.DefaultProcessingInstruction;
import device.s.docreader.office.fc.dom4j.tree.DefaultText;
import device.s.docreader.office.fc.dom4j.tree.QNameCache;
import device.s.docreader.office.fc.dom4j.util.SimpleSingleton;
import device.s.docreader.office.fc.dom4j.util.SingletonStrategy;
import device.s.docreader.office.fc.dom4j.xpath.DefaultXPath;
import device.s.docreader.office.fc.dom4j.xpath.XPathPattern;
...
public class DocumentFactory implements Serializable
{
    ...
    private static SingletonStrategy createSingleton()
    {
        ...
        try
        {
            documentFactoryClassName = System.getProperty("device.s.docreader.office.fc.dom4j.factory",
                "device.s.docreader.office.fc.dom4j.DocumentFactory");
        }
        catch(Exception e)
        {
            documentFactoryClassName = "device.s.docreader.office.fc.dom4j.DocumentFactory";
        }

        try
        {
            String singletonClass = System.getProperty(
                "device.s.docreader.office.fc.dom4j.DocumentFactory.singleton.strategy", "device.s.docreader.office.fc.dom4j.util.SimpleSingleton");
