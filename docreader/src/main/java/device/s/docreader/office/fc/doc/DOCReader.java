...
import device.s.docreader.office.common.bookmark.Bookmark;
import device.s.docreader.office.common.borders.Border;
import device.s.docreader.office.common.borders.Borders;
import device.s.docreader.office.common.borders.Line;
import device.s.docreader.office.common.bulletnumber.ListData;
import device.s.docreader.office.common.bulletnumber.ListLevel;
...
import device.s.docreader.office.common.shape.WPAbstractShape;
import device.s.docreader.office.common.shape.WPAutoShape;
import device.s.docreader.office.common.shape.WPGroupShape;
import device.s.docreader.office.common.shape.WPPictureShape;
...
import device.s.docreader.office.fc.ddf.EscherTextboxRecord;
...
import device.s.docreader.office.fc.hwpf.model.PicturesTable;
import device.s.docreader.office.fc.hwpf.usermodel.Bookmarks;
import device.s.docreader.office.fc.hwpf.usermodel.BorderCode;
import device.s.docreader.office.fc.hwpf.usermodel.CharacterRun;
import device.s.docreader.office.fc.hwpf.usermodel.Field;
import device.s.docreader.office.fc.hwpf.usermodel.HWPFAutoShape;
import device.s.docreader.office.fc.hwpf.usermodel.HWPFShape;
import device.s.docreader.office.fc.hwpf.usermodel.HWPFShapeGroup;
import device.s.docreader.office.fc.hwpf.usermodel.HeaderStories;
import device.s.docreader.office.fc.hwpf.usermodel.InlineWordArt;
import device.s.docreader.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import device.s.docreader.office.fc.hwpf.usermodel.OfficeDrawing;
import device.s.docreader.office.fc.hwpf.usermodel.OfficeDrawings;
import device.s.docreader.office.fc.hwpf.usermodel.POIBookmark;
import device.s.docreader.office.fc.hwpf.usermodel.Paragraph;
import device.s.docreader.office.fc.hwpf.usermodel.PictureType;
import device.s.docreader.office.fc.hwpf.usermodel.Range;
import device.s.docreader.office.fc.hwpf.usermodel.Section;
import device.s.docreader.office.fc.hwpf.usermodel.Table;
import device.s.docreader.office.fc.hwpf.usermodel.TableCell;
import device.s.docreader.office.fc.hwpf.usermodel.TableRow;
import device.s.docreader.office.fc.util.LittleEndian;
import device.s.docreader.office.java.awt.Rectangle;
import device.s.docreader.office.java.util.Arrays;
...
import device.s.docreader.office.wp.model.HFElement;
import device.s.docreader.office.wp.model.RowElement;
import device.s.docreader.office.wp.model.TableElement;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	device.s.docreader.office.java.awt.Color fillColor = shape.getForegroundColor();
            	device.s.docreader.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            device.s.docreader.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            device.s.docreader.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
