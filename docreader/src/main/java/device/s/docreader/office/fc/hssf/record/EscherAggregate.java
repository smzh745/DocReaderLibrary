...
import device.s.docreader.office.fc.ddf.DefaultEscherRecordFactory;
import device.s.docreader.office.fc.ddf.EscherBoolProperty;
import device.s.docreader.office.fc.ddf.EscherClientAnchorRecord;
import device.s.docreader.office.fc.ddf.EscherClientDataRecord;
...
import device.s.docreader.office.fc.ddf.EscherRecordFactory;
import device.s.docreader.office.fc.ddf.EscherSerializationListener;
import device.s.docreader.office.fc.ddf.EscherSpRecord;
import device.s.docreader.office.fc.ddf.EscherSpgrRecord;
import device.s.docreader.office.fc.ddf.EscherTextboxRecord;
import device.s.docreader.office.fc.hssf.model.AbstractShape;
import device.s.docreader.office.fc.hssf.model.CommentShape;
import device.s.docreader.office.fc.hssf.model.ConvertAnchor;
import device.s.docreader.office.fc.hssf.model.DrawingManager2;
import device.s.docreader.office.fc.hssf.model.TextboxShape;
...
import device.s.docreader.office.fc.hssf.usermodel.HSSFShapeContainer;
import device.s.docreader.office.fc.hssf.usermodel.HSSFShapeFactory;
