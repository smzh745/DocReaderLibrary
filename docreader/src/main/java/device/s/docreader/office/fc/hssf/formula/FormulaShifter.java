...
import device.s.docreader.office.fc.hssf.formula.ptg.Area2DPtgBase;
...
import device.s.docreader.office.fc.hssf.formula.ptg.RefPtgBase;
...
public final class FormulaShifter {
     ...
     *
     * For example, this will be called on {@link device.s.docreader.office.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)} }
     */
     ...
     *
     * For example, this will be called on {@link device.s.docreader.office.fc.hssf.usermodel.HSSFWorkbook#setSheetOrder(String, int)}
     */
